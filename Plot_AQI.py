...
def avg_data_2010():
    temp_i=0
    average=[]
    for rows in pd.read_csv('Data/AQI/aqi2010.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
...
def avg_data_2011():
    temp_i=0
    average=[]
    for rows in pd.read_csv('Data/AQI/aqi2011.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
        df=pd.DataFrame(data=rows)
...
def avg_data_2012():
    temp_i=0
    average=[]
    for rows in pd.read_csv('Data/AQI/aqi2012.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
        df=pd.DataFrame(data=rows)
...
if __name__=="__main__":
    lst2013=avg_data_2010()
    lst2013=avg_data_2011()
    lst2013=avg_data_2012()
    ...
    lst2013=avg_data_2019()
    plt.plot(range(0,121),lst2010,label="2010 data")
    plt.plot(range(0,121),lst2011,label="2011 data")
    plt.plot(range(0,121),lst2012,label="2012 data")
    ...
    plt.plot(range(0,121),lst2017,label="2017 data")
    plt.plot(range(0,121),lst2018,label="2018 data")
    plt.plot(range(0,121),lst2019,label="2019 data")
    plt.xlabel('Day')
    plt.ylabel('PM 2.5')
